...
const ko = {
  fixed: '고정',
  default: '기본값',
  save_as_custom_field: '사용자 정의 필드로 저장',
  kba: 'KBA',
  analyzing_: '분석 중...',
  download: '다운로드',
  downloading_: '다운로드 중...',
  view: '보기',
  autodetect_fields: '필드 자동 감지',
  payment_link: '결제 링크',
  strikeout: '취소선',
  draw_strikethrough_the_document: '문서에 취소선 그리기',
  quantity: '수량',
  prefillable: '사전 입력 가능',
  signature_id: '서명 ID',
  ...
  date_signed: '서명 날짜',
  method: '방법',
  reorder_fields: '필드 순서 변경',
  verify_id: 'ID 확인',
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more: '신뢰할 수 있는 공급자로부터 공인 전자서명(QeS)을 받으세요. 자세히 알아보려면 클릭하세요.',
  editable: '편집 가능',
  recurrent: '반복',
  one_off: '일회성',
  search_field: '필드 검색',
  ...
  width: '너비',
  height: '높이',
  add_all_required_fields_to_continue: '계속하려면 모든 필수 필드를 추가하세요',
  uploaded_pdf_contains_form_fields_keep_or_remove_them: '업로드된 PDF에 양식 필드가 있습니다. 유지하거나 제거하시겠습니까?',
  keep: '유지',
  left: '왼쪽',
  heading: '제목',
  validation: '유효성 검사',
  add_blank_page: '빈 페이지 추가',
  right: '오른쪽',
  center: '가운데',
  description: '설명',
  display_title: '표시 제목',
  ...
  type: '유형',
  list: '목록',
  no_variables: '아직 변수가 없습니다',
  no_variables_description: '문서에 [[variable]] 표시를 추가하여 동적 콘텐츠 변수를 만드세요.',
  type_value: '값 입력',
  equal: '같음',
  not_equal: '같지 않음',
  greater_than: '보다 큼',
  ...
  add_condition: '조건 추가',
  are_you_sure_: '정말 하시겠습니까?',
  sign_yourself: '직접 서명',
  set_signing_date: '서명 날짜 설정',
  signing_date: '서명 날짜',
  signing_date_and_time: '서명 날짜 및 시간',
  send: '보내기',
  remove: '제거',
  edit: '편집',
  settings: '설정',
  ...
  any: '모두',
  drawn: '그리기',
  drawn_or_typed: '그리기 또는 입력',
  drawn_or_upload: '그리기 또는 업로드',
  upload: '업로드',
  formula: '수식',
  typed: '입력',
  draw_field_on_the_document: '문서에 필드 그리기',
  click_to_upload: '클릭하여 업로드',
  or_drag_and_drop_files: '또는 파일을 드래그하여 놓으세요',
  uploading: '업로드 중',
  processing_: '처리 중...',
  add_pdf_documents_or_images: 'PDF 문서 또는 이미지 추가',
  add_documents_or_images: '문서 또는 이미지 추가',
  add_a_new_document: '새 문서 추가',
  replace_existing_document: '기존 문서 교체',
  clone_and_replace_documents: '문서 복제 및 교체',
  required: '필수',
  default_value: '기본값',
  format: '형식',
  read_only: '읽기 전용',
  page: '페이지',
  draw_new_area: '새 영역 그리기',
  copy_to_all_pages: '모든 페이지에 복사',
  more: '더 보기',
  add_option: '옵션 추가',
  option: '옵션',
  options: '옵션 목록',
  condition: '조건',
  make_dynamic: '동적으로 만들기',
  first_party: '제1 당사자',
  second_party: '제2 당사자',
  third_party: '제3 당사자',
  fourth_party: '제4 당사자',
  fifth_party: '제5 당사자',
  sixth_party: '제6 당사자',
  seventh_party: '제7 당사자',
  eighth_party: '제8 당사자',
  ninth_party: '제9 당사자',
  tenth_party: '제10 당사자',
  eleventh_party: '제11 당사자',
  twelfth_party: '제12 당사자',
  thirteenth_party: '제13 당사자',
  fourteenth_party: '제14 당사자',
  fifteenth_party: '제15 당사자',
  sixteenth_party: '제16 당사자',
  seventeenth_party: '제17 당사자',
  eighteenth_party: '제18 당사자',
  nineteenth_party: '제19 당사자',
  twentieth_party: '제20 당사자',
  draw: '그리기',
  add: '추가',
  or_add_field_without_drawing: '또는 그리기 없이 필드 추가',
  text: '텍스트',
  number: '숫자',
  signature: '서명',
  initials: '이니셜',
  ...
  initials_field: '이니셜 필드',
  date_field: '날짜 필드',
  number_field: '숫자 필드',
  image_field: '이미지 필드',
  file_field: '파일 필드',
  select_field: '선택 필드',
  checkbox_field: '체크박스 필드',
  multiple_field: '다중 선택 필드',
  radio_field: '라디오 그룹 필드',
  cells_field: '셀 필드',
  stamp_field: '스탬프 필드',
  payment_field: '결제 필드',
  phone_field: '전화 필드',
  draw_a_text_field_on_the_page_with_a_mouse: '마우스로 페이지에 텍스트 필드를 그리세요',
  drag_and_drop_any_other_field_type_on_the_page: '다른 필드 유형을 페이지로 드래그 앤 드롭하세요',
  click_on_the_field_type_above_to_start_drawing_it: '위의 필드 유형을 클릭하여 그리기를 시작하세요',
  please_draw_fields_to_prepare_the_document: '문서를 준비하려면 필드를 그려주세요.',
  only_pdf_and_images_are_supported: 'PDF와 이미지만 지원됩니다.',
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification: '유료 플랜으로 SMS 인증 전화번호 필드를 사용하세요. 인증 없이 전화번호를 사용하려면 텍스트 필드를 사용하세요.',
  available_only_in_pro: 'Pro 버전에서만 사용 가능',
  failed_to_download_files: '파일 다운로드 실패',
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed: '{submitter_name}에 대한 필드를 추가하거나, 필요하지 않으면 {submitter_name}을(를) 제거하세요.',
  draw_field: '{field} 필드 그리기',
  replace: '교체',
  uploading_: '업로드 중...',
  add_document: '문서 추가',
  none: '없음',
  ...
  numbers_only: '숫자만',
  letters_only: '문자만',
  regexp_validation: '정규식 유효성 검사',
  custom_validation: '사용자 정의 유효성 검사',
  length_validation: '길이 유효성 검사',
  number_range: '숫자 범위',
  enter_pdf_password: 'PDF 비밀번호 입력',
  wrong_password: '잘못된 비밀번호',
  currency: '통화',
  save_and_preview: '저장 및 미리보기',
  preferences: '환경설정',
  available_in_pro: 'Pro 버전에서 사용 가능',
  some_fields_are_missing_in_the_formula: '수식에서 일부 필드가 누락되었습니다.',
  learn_more: '자세히 알아보기',
  and: '그리고',
  or: '또는',
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document: '빠른 둘러보기를 시작하여 첫 번째 문서를 만들고 보내는 방법을 알아보세요',
  start_tour: '둘러보기 시작',
  or_add_from: '또는 다음에서 추가',
  sync: '동기화',
  syncing: '동기화 중...',
  copy: '복사',
  paste: '붙여넣기',
  ...
  align_top: '위쪽 정렬',
  align_bottom: '아래쪽 정렬',
  fields_selected: '{count}개 필드 선택됨',
  field_added: '{count}개 필드 추가됨',
  fields_added: '{count}개 필드 추가됨',
  revisions: '수정 기록',
  apply: '적용',
  no_revisions_yet: '아직 수정 기록이 없습니다',
  viewing_revision_from: '{date}의 수정 기록 보는 중'
}

export { en, es, it, pt, fr, de, nl, ko }
